...
const index = () => {
    ...
    return (
        <Page title='PO Supplier Customer'>
            <Container>
                <Grid container>
                    <Grid item xs={12} md={12}>
                        <Stack direction='row' justifyContent='space-between' alignItems='center'>
                            ...
                            <Button onClick={() => navigate('/external-order/po-supplier-customer/add')} variant='contained' startIcon={<Iconify icon='ic:baseline-plus'  />}>
                                Input
                            </Button>
                        </Stack>
                    </Grid>
