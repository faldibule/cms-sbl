                    ...
                    <Stack direction='row' justifyContent='space-between' alignItems='center'>
                        <Stack>
                            <Typography variant='h5'>
                                Detail History PR Catering - {data.pr_number}
                            </Typography>
                            <Breadcrumbs sx={{ fontSize: '0.8rem', mt: 1 }}>
                                <CustomLinkBreadcrumsComponent title='PR Catering' to="/internal-order/pr-catering" />
                                <CustomLinkBreadcrumsComponent title='History PR Catering' to={`/internal-order/history-pr-catering/${props.data.reference_id}`} />
                                <Typography sx={{ fontSize: '0.8rem' }}  color="text.primary">Detail History PR Catering</Typography>
                            </Breadcrumbs>
                        </Stack>
                    </Stack>
                </Grid>
