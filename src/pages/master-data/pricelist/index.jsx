            ...
            <Container>
                <Grid container spacing={1}>
                                            ...
                                            {rows.slice(params.page * params.limit, params.page * params.limit + params.limit).map((v, i) => {
                                                return (
                                                    <TableRow key={i}>
                                                        ...
                                                        <TableCell>{NumberFormat(v.price, 'Rp')}</TableCell>
                                                        <TableCell>
                    ...
                    <Grid item xs={12} md={5}>
                        <Card sx={{ p: 2 }}>
                            <Typography mb={3} variant='h6'>Form Pricelist</Typography>
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={6}>
                                    <TextField
                                        ...
                                        select
                                    >
                                        <MenuItem value='1'>Supplier Type 1</MenuItem>
                                        <MenuItem value='2'>Supplier Type 2</MenuItem>
                                    </TextField> 
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <TextField
