...
for(let i = 0; i < 15; i++){
    dummy[i] = {
        customer_type: `Customer Type ${i + 1}`,
        company_name: `Customer ${i + 1}`,
        customer_contact_person: '085858585858',
        customer_address: `Customer address ${i + 1}`,
        customer_email: `customer${i + 1}@gmail.com`,
        customer_phone: '085858585858',
    }
}
            ...
            <Container>
                <Grid container spacing={1}>
                                            ...
                                            {rows.slice(params.page * params.limit, params.page * params.limit + params.limit).map((v, i) => {
                                                return (
                                                    <TableRow key={i}>
                                                        ...
                                                        <TableCell>{v.customer_type}</TableCell>
                    ...
                    <Grid item xs={12} md={5}>
                        <Card sx={{ p: 2 }}>
                            <Typography mb={3} variant='h6'>Form Customer</Typography>
